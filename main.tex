...
\author{Jan Szymenderski$^{1,2}$, Przemysław Sałapata$^{1,3}$}
...
\\ \protect\href{mailto:przemyslaw.salaptata@student.put.poznan.pl}{$^{3}$przemyslaw.salaptata@student.put.poznan.pl}\\}
